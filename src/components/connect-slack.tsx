...
export function ConnectSlack() {
  ...
  return (
    <button
      ...
      disabled={connecting}
      className="w-full flex items-center justify-center gap-3 bg-[#4A154B] hover:bg-[#3a1139] disabled:opacity-50 text-white font-medium px-4 py-3 rounded-lg transition-colors"
    >
